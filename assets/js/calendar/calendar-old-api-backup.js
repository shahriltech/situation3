var clientId = '987202405297-rgdt3v1c6178q45mvvncakjnqt849ac3.apps.googleusercontent.com'; //choose web app client Id, redirect URI and Javascript origin set to http://localhost
var apiKey = 'AIzaSyD0XdEPbz2y_4mxYYMjxa539iXh1tf_tzg'; //choose public apiKey, any IP allowed (leave blank the allowed IP boxes in Google Dev Console)
var userEmail = "madlabs.com.my_hdb005ir0dksqm4q3s5gr2co7k@group.calendar.google.com"; //your calendar Id
var userTimeZone = "Kuala Lumpur"; //example "Rome" "Los_Angeles" ecc...
var maxRows = 7; //events to shown
var calName = "Annual Leave"; //name of calendar (write what you want, doesn't matter)
...
function makeApiCall() {
    ...
    addDate.setDate(addDate.getDate() + 30); // add 2 days 
    ...
    request.execute(function (resp) {
        if (resp.items.length > 0) {
            for (var i = 0; i < resp.items.length; i++) {
                console.log(resp.items[i].summary + " annual");
                ...
                document.getElementById('annual').appendChild(li);
            }
        }
        else{
            var text = "<font size='5'>No Event</font>"
            
            document.getElementById('annual').innerHTML = text;
